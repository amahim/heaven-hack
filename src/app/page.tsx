    ...
    <>
      ...
      <section className="section bg-dark-solid" id="why-choose">
        <div className="container">
          ...
          <div className="why-slider-controls-wrapper">
            ...
            {/* Theme-styled Slider Progress Bar */}
            <div className="why-slider-track-container">
              <div
                className="why-slider-progress-bar"
                style={{
                  width: `${Math.min(100, Math.max(16, ((activeCardIndex + 1) / Math.max(1, PILLARS.filter((p) => whyFilter === "all" || p.category === whyFilter).length)) * 100))}%`
                }}
              />
            </div>
          </div>
